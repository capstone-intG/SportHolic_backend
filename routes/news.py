...
@news_route.route("/api/news/block_headlines", defaults={"category": None, "date": None}, methods=['GET'])
@news_route.route("/api/news/block_headlines/<category>",defaults={"date": None}, methods=['GET'])
@news_route.route("/api/news/block_headlines/<category>/<date>", methods=['GET'])
@jwt_required()
def block_headlines(category, date):
    ...
    if category is not None:    
        ...
        if date is None:
            ...
            try:
                ...
                res = [post.headline for post in posts if post.written_date == date]
            except:
